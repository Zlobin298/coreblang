...
public class CompilerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "TYPE", "BOOL", 
			"CHAR", "INT_LITERAL", "FLOAT_LITERAL", "PLUS", "MINUS", "MUL", "DIV", 
			"NOT", "AND", "OR", "LARGER", "LESS", "LARGER_E", "LESS_E", "EQUALS", 
			"NOT_EQUALS", "ID", "WS"
		};
	}
